...
echo "</div>";
?>
          <a href='xiugai1.php'><input type='button' id='input3' value='change password' /></a>
        </div>
      </div>
      <div id="right">
        <div id="right2">
  ...
  echo "<table id='tab' border='0'rules='none'><tr class='head'><th width='630px'>Title</th><th width='260px'>Author</th></tr>";
