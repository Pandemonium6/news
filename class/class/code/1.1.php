...
echo "</div>";
?>
          <a href='xiugai1.php'><input type='button' id='input3' value='change password' /></a></br>
          <a href='exit.php'><input type="button" id="input4" value="Exit">  </a>
        </div>
      </div>
      <div id="right">
        <div id="right2">
          <div id="rightone">
            <div id='r1wen'><form action="1.11.php" method='post'>
          <input type="text" name="search" placeholder="            author" />
          <input type='submit' id="search" value="Search" /> </form></div>
            <!-- <div id="hh">
  ...
  echo "<table id='tab' border='0'rules='none'><tr class='head'><th width='630px'>News</th><th width='260px'>Reporter</th></tr>";
