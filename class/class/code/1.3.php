...
<body>
  ...
  <?php
    ...
    echo '</a></br>';
     ...
     if($totalnum!=0){   
     $info=mysql_fetch_assoc($result);
    echo "<p align='right' ><a href=1.3.php?id=".$info['id']."> <font color='darkviolet' size='3'><b>Previous News</b>&nbsp;&nbsp;&nbsp;</font></a></p>";}
    $result=mysql_query("Select * from title where id>".$id,$conn);
    $totalnum=mysql_num_rows($result);
    if($totalnum!=0){
    $info=mysql_fetch_assoc($result);
   ...
   echo "<p  align='right'><a href=1.3.php?id=".$info['id'].">  <font color='darkviolet' size='3'><b>Next News</b>&nbsp;&nbsp;&nbsp;</font></a></p>";}
    echo' </div></div></br>';
