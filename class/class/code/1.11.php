...
echo $info['tel'];
echo "</div>";
?><div id=left3><a href='exit.php'><input type="button" id="back" value="Exit">
</a></div>
  ...
  echo "<table border='0' id='tab'rules='none'><tr class='head'><th width='630px'>News</th><th width='260px'>Reporter</th></tr>";
